# python visual_hm.py /path/to/img_*.jpg
...
if __name__=='__main__':
    ...
    #nclass = 38
    nclass = 2
    save_hm_path = "/path/to/deeplabv3plus_pixelWise/results/heatmaps/"
    model_path = "/path/to/icdar_models/run/icdar/deeplab-resnet/model_best.pth.tar"
    alphabet="#abcdefghijklmnopqrstuvwxyz1234567890@" 
    img_path = "/path/to/img_55.jpg"
    ...
    for i in range(0,2):
        ...
        plt.axis('off')
        fig.savefig(save_hm_path+img_name+"_hm_{}_{}.png".format(i, alphabet[i]), bbox_inches='tight')
        plt.close(fig)
